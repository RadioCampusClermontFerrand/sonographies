...
<html lang="en">
  ...
  <?php 
      ...
      $balades = array(
                                       array("id" => "anecdotrain",
                            "nom" => "L'anecdo-train",
                                      "description" => "<p>Une promenade agréable et insolite à la découverte du quartier de la gare de Clermont, riche en anecdotes et lieux à explorer !</p><p> Les enregistrements te parlerons de ses rues, de ses histoires et des personnes méconnues qui le font vibrer, dans le présent comme dans le souvenir d'un temps passé.</p><p>La voix profonde et charmante du narrateur sera ton amie fidèle tout le long du chemin, jusqu'à te laisser pour t'inviter à continuer l'exploration de la vieille ville, désormais muni.e d'un regard observateur et un esprit curieux.</p><p>C'est parti !</p>",
                            "lientelechargement" => "balade6/l'anecdo-train.zip",
                              "auteurs" =>  "<p>Atelier avec le master ISDT - Radio Campus Clermont-Ferrand Année 2020/2021<br />
                                                    <strong>Réalisation&nbsp;:</strong>Maxime Lebaron, Merveille Tawab, Marie-Sophie Rohmer, Eliana Biasiol, Amira Jemai et Chaimaa El Ouahabi, étudiants du master ISDT<br />
                                                    <strong>Voix comédien&nbsp;:</strong> Pierre-Henri Malartre<br />
                                                    <strong>Design graphique&nbsp;:</strong> Maxime Lebaron<br />
                                                    ...
                                                    <strong>Création&nbsp;:</strong> Mars 2021
                                                    </p>",
                            "coordonnees" => array(45.778825, 3.100848),
                            "mp3" => array(array("fichier" => "balade6/0-Intro.mp3",                                                           "nom" => "Grand départ"),                                           array("fichier" => "balade6/1-La gare.mp3",                                                           "nom" => "la gare a changé, le quartier aussi!"),                                           array("fichier" => "balade6/2-L'hôtel des vil-e-s.mp3",                                                           "nom" => "L’Hôtel des Vil-e-s"),                                           array("fichier" => "balade6/3-La grenouillère.mp3",                                                           "nom" => "La Grenouillère"),                                           array("fichier" => "balade6/4-Lycée Jeanne d’Arc.mp3",                                                           "nom" => "Lycée Jeanne d’Arc"),                                           array("fichier" => "balade6/5-Un joli hôtel.mp3",                                                           "nom" => "Un joli hôtel qui cache une histoire méconnue"),                                           array("fichier" => "balade6/6-Banquise.mp3",                                                           "nom" => "Banquise"),                                           array("fichier" => "balade6/7-La mode.mp3",                                                           "nom" => "La mode au fil du temps"),                                           array("fichier" => "balade6/8-Fin.mp3",                                                           "nom" => "FIN")                                                           ),                            "carteimg" => "balade6/anecdo-train.png"),
                      ...
                      array("id" => "walktrip",
                            ...
                            "carteimg" => "balade4/walktrip.png"),
                                                array("id" => "sonnet",                            "nom" => "Sonnet la ballade",                                      "description" => "<p>A travers les âges et le temps nous vous souhaitons</p><p>Une balade sonore dans de bonnes conditions</p><p>Découverte du patrimoine de Clermont</p><p>En musique et en sons nous vous proposons</p><p></p><p>Laissez vous comme le merle porter par le vent</p><p>D’une ruelle à l’autre, dans Clermont-Ferrand</p><p>De la pierre de Volvic à nos beaux volcans</p><p>En passant par la voix de nos manifestants</p><p></p><p>Pour vous l’histoire n’aura plus aucun secret</p><p>Réjouissez vous car nous allons les dévoiler</p><p>Par le fil de nos voix au gré des pavés</p><p></p><p>Sonne le glas du départ de la balade</p><p>Partons vite pour cette dite croisade</p><p>Les découvertes se feront en cascade</p><p></p><p>Inauguration officielle le 19 septembre 2020 à 10h départ de l'Office de Tourisme.",                            "lientelechargement" => "balade5/sonnet la ballade.zip",                            "auteurs" =>  "<p>Radio Campus Clermont-Ferrand Année 2019/2020<br />                                                    <strong>Design graphique&nbsp;:</strong> Lucile Mathieu<br />                                                    <strong>Production&nbsp;:</strong> <a href=\"http://campus-clermont.net\">Radio Campus Clermont-Ferrand</a><br />                                                    <strong>Création&nbsp;:</strong> septembre 2020                                                    </p>",                            "coordonnees" => array(45.778043, 3.085561),                            "mp3" => array(array("fichier" => "balade5/0- L’envol.mp3",                                                           "nom" => "L’envol"),                                           array("fichier" => "balade5/1- La croisade.mp3",                                                           "nom" => "La croisade"),                                           array("fichier" => "balade5/2-La pierre de Volvic.mp3",                                                           "nom" => "La pierre de Volvic"),                                           array("fichier" => "balade5/3-La place du marché.mp3",                                                           "nom" => "La place du marché"),                                           array("fichier" => "balade5/4-La fontaine d'Amboise.mp3",                                                           "nom" => "La fontaine d'Amboise"),                                           array("fichier" => "balade5/5-La case prison.mp3",                                                           "nom" => "La case prison"),                                           array("fichier" => "balade5/6-La bouche de métro.mp3",                                                           "nom" => "La bouche de métro"),                                           array("fichier" => "balade5/7-La voix du peuple.mp3",                                                           "nom" => "La voix du peuple"),                                           array("fichier" => "balade5/8-La huitième merveille.mp3",                                                           "nom" => "La huitième merveille")                                                           ),                            "carteimg" => "balade5/sonnet.png")
          );
...
$idPastilleAffichage=$idPastille-1;//variable d'affichage pour la balade 5 qui comporte une pastille 0 
                                if ($balade == "anecdotrain" OR $balade == "sonnet") echo '<div class="list-group-item entry-2buttons">Pastille '. $idPastilleAffichage; else                                    echo '<div class="list-group-item entry-2buttons">Pastille '. $idPastille;
